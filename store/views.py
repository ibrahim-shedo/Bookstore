...
from .models import Category, Writer, Book, Review, Slider, Message
...
def send_message(request):
    if request.method == 'POST':
        ...
        message = Message(
            ...
            read=False  # Set the message as unread by default
        )
        message.save()
    ...
    # If the request is not a POST request, render the send message template
